            ...
            <>
                ...
                <div className="nav-dropDown-page animate-[extendHeight_0.3s_ease-in-out_forwards]">
                    ...
                    className="nav-dropDown-item pt-12 animate-[fadeIn_0.3s_ease-in-out_0.1s_forwards]"
                        >Introduction</Link>
                    <Link to="/home" className="nav-dropDown-item       animate-[fadeIn_0.3s_ease-in-out_0.15s_forwards]">Education</Link>
                    <Link to="/home" className="nav-dropDown-item pb-12 animate-[fadeIn_0.3s_ease-in-out_0.20s_forwards]">Skills</Link>
                </div>
            </>
        )
    );
