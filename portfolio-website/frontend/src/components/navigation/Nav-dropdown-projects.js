        ...
        ProjectsdropDownIsVisible && (
            <>
                ...
                <div className="nav-dropDown-page animate-[extendHeight_0.3s_ease-in-out_forwards]">
                    <Link to="/projects/os" className="nav-dropDown-item pt-12 animate-[fadeIn_0.3s_ease-in-out_0.1s_forwards]">Operating System Engineering</Link>
                    <Link to="/" className="nav-dropDown-item animate-[fadeIn_0.3s_ease-in-out_0.15s_forwards]">My Portfolio</Link>
